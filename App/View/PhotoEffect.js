            ...
            <View style={[{}, styles.TopBar]}>
              <View style={[{}, styles.TopBarImageViw]}>
                <TouchableOpacity>
                  <Image
                    ...
                    source={require('../images/icons/icon-camera.png')}></Image>
              ...
              <View style={[{}, styles.TopBarImageViw]}>
                <TouchableOpacity>
                  <Image
                    style={[{}, styles.TopbarImg]}
                    source={require('../images/icons/speed-07.png')}></Image>
              ...
              <View style={[{}, styles.TopBarImageViw]}>
                <TouchableOpacity>
                  <Image
                    style={[{}, styles.TopbarImg]}
                    source={require('../images/icons/filter-08.png')}></Image>
              ...
              <View style={[{}, styles.TopBarImageViw]}>
                <TouchableOpacity>
                  <Image
                    style={[{}, styles.TopbarImg]}
                    source={require('../images/icons/timer-09.png')}></Image>
              ...
              <View style={[{}, styles.TopBarImageViw]}>
                <TouchableOpacity>
                  <Image
                    style={[{}, styles.TopbarImg]}
                    source={require('../images/icons/flash-10.png')}></Image>
              ...
              <View style={[{}, styles.TopBarImageViw]}>
                <TouchableOpacity>
                  <Image
                    style={[{}, styles.TopbarImg]}
                    source={require('../images/icons/beauty.png')}></Image>
              ...
              <View style={[{}, styles.TopBarImageViw]}>
                <TouchableOpacity>
                  <Image
                    style={[{}, styles.TopbarImg]}
                    source={require('../images/icons/sound-12.png')}></Image>
                  <Text style={[{}, styles.TopbarImgText]}>Sound</Text>
                </TouchableOpacity>
              </View>
            </View>
            <View style={[{alignSelf: 'baseline'}, styles.BottomBar]}>
              <View style={[{}, styles.BottomBarImageViw]}>
                <TouchableOpacity>
                  <Image
                    style={[{}, styles.TopbarImg]}
                    source={require('../images/icons/effects-13.png')}></Image>
              ...
              <View style={[{}, styles.BottomBarImageViw]}>
                <TouchableOpacity
                  ...
                  <Image
                    style={[{}, styles.TopbarImg]}
                    source={require('../images/icons/capture-15.png')}></Image>
                </TouchableOpacity>
              </View>
              <View style={[{}, styles.BottomBarImageViw]}>
                <TouchableOpacity>
                  <Image
                    style={[{}, styles.TopbarImg]}
                    source={require('../images/icons/upload-14.png')}></Image>
